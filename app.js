...
app.route("/signin")
  .get((req, res) => {
    res.render('signin'); // This will render the signin.ejs view
  })
  .post((req, res) => {
    // Handle signin logic (e.g., check credentials)
    // After checking credentials, you can redirect to home page
    res.redirect('/'); // Redirect to the home page after successful signin
  });
